                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="illustrationphp.php">Illustrations</a></li>
        ...
        <section class="row mt-5 text-center">
            <div class="col-md-6 m-auto">
                ...
                <form action="./leadgeneration.php" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="profession" id="profession" class="form-control" placeholder="What do you for a living (Optional)">
                    </div>
