...
<body>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="test2.php?product=<?php echo $product['product_id']; ?>" id="link-color" class="btn btn-primary">Pay USD <?php echo htmlspecialchars($product['product_price']); ?></a>
                        </div>
                    </div>
                </div>
            <?php } ?>
    ...
    <div class="container py-5">
        ...
        <a href="calendly.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Schedule a call</a>
    </div>
