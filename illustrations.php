<?php
//connect to database
$conn = mysqli_connect('localhost', 'roosevi0_Kurinton', '@@90210@@', 'roosevi0_illustrations');
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="illustrationdetail.php?product=<?php echo $product['product_id']; ?>" id="link-color" class="btn btn-primary">Pay USD <?php echo htmlspecialchars($product['product_price']); ?></a>
            </div>
          </div>
        </div>
      <?php } ?>
