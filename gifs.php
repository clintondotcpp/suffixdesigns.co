<?php
    //connect to database
    $conn = mysqli_connect('localhost', 'roosevi0_Kurinton', '@@90210@@', 'roosevi0_gifs');
...
<video src="<?php echo $product['product_video'];?>" autoplay loop muted></video>
  <div class="card-body">
    ...
    <a href="gifdetail.php?product=<?php echo $product['product_id'];?>" id="link-color" class="btn btn-primary">Pay USD <?php echo htmlspecialchars($product['product_price']);?></a>
  </div>
</div>
</div>
<?php }?>
