<?php
//connect to database
$conn = mysqli_connect('localhost', 'Kurinton', '@@90210@@', 'fliers');
...
<body>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p>USD$ <?php echo htmlspecialchars($product['product_price']); ?></p>
              <a href="flierdetail.php?product=<?php echo $product['product_id']; ?>" id="link-color" class="btn btn-dark">View Details</a>
            </div>
          </div>
        </div>
      <?php } ?>
  ...
  <div class="container py-5">
    <h4>Don't see what you like? Make a custom request by Emailing us.</h4>
    <a href="mailto:info@suffixdesigns.co" class="btn btn-dark btn-lg active" role="button" aria-pressed="true">Email us</a>
  </div>
      ...
      <div class="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <div class="d-flex flex-column flex-sm-row w-100 gap-2">
            ...
            <input id="newsletter1" type="text" class="form-control" placeholder="Email address" name="email" required>
