...
try {
    $conn = new mysqli('localhost', 'roosevi0_Kurinton', '@@90210@@', 'roosevi0_photogifs');
...
?>
        ...
        <head>
            ...
            <title>Photo GIF Template</title>
                ...
                <div class="container my-5">
                    <div class="row g-5 py-5 mb-5">
                        <div class="col-md-5 col-lg-4 order-md-last py-5">
                            ...
                            <video src="<?php echo $product['product_video']; ?>" autoplay loop muted width="250" height="250"></video>
