...
/*`product_id`, `product_name`, `product_img`, `product_price`, `product_description`, */
    try{
        $conn = new mysqli('localhost', 'Kurinton', '@@90210@@', 'photogifs');
...
<head>
    ...
    <title>Photo GIFs: Template <?php echo $id?></title>
...
<body>
    ...
    <form method="post" action="orderupload.php?product=<?php $product['product_name'];?>" enctype="multipart/form-data">
