...
try {
    $conn = new mysqli('localhost', 'roosevi0_Kurinton', '@@90210@@', 'roosevi0_salesoffer');
...
?>
        ...
        <head>
            ...
            <title>Suffix Designs: Template</title>
                ...
                <div class="container my-5">
                    <div class="row g-5 py-5 mb-5">
                        ...
                        <div class="col-md-7 col-lg-8 py-5">
                            <form action="orderupload.php?product=<?php echo $product['stripe_id']; ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                <div class="row gy-3">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <textarea id="" cols="30" rows="5" name="instructions" name="instructions" placeholder="Customize your design. This is optional. We will contact you regardless via email within 24hrs to ask for more details or pictures for optimal satisfaction."></textarea>
                                    </div>
                                </div>
