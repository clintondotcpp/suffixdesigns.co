        ...
        <div class="container my-5">
            <div class="row g-5 py-5 my-5">
                <div class="col-md-12 pt-5 mt-5">
                    <h1 class="text-center"> Growth Content Creation Plan</h1>
                    <h5 class="text-center">$995/month</h5>
                    <h3>The Growth plan is designed to help small and medium scale business owners scale their business using great
                        content marketing designs.
                    </h3>
                    <h3> Design requests can be made via Trello, Slack or Emails</h3>
                    <ul>
                        <li>
                            <h4>20 design requests</h4>
                        </li>
                        <li>
                            <h4>Unlimited revisions</h4>
                        </li>
                        <li>
                            <h4>Pause or cancel subscription at anytime.</h4>
                        </li>
                    </ul>
                </div>
                <div class="col-md-12 col-lg-12 py-2">
                    <form method="post" action="../create-subscription-session?price=price_1LmzbvGvSc684TudeYvFinvb" class="needs-validation" novalidate>
                        <div class="row gy-3">
                            <div class="col-12">
