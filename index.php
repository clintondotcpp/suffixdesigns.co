...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="Assets/SUFFIX.png" alt="" width="100" height="100"></a>
    ...
    <section id="categories" class="p-5">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card">
                    <video autoplay loop muted>
                        <source src="Template 001.mp4" type="video/mp4">
            ...
            <div class="col">
                <div class="card">
                    <video autoplay loop muted>
                        ...
                        <source src="PHOTOGIF/Template 001.ogg" type="video/ogg">
