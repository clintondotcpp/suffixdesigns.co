...
//$local_dir = 'C:\xampp\htdocs\mywebsite\Assets\Fliers';
//$local_server_dir = 'FLIERS';
...
for($i = 0; $i < count($files); $i++){
    ...
    ";
    $query = "INSERT IGNORE INTO products (product_name,product_img,product_price,product_description) VALUES ('$word', '$http_path', '$product_price','$product_description')";
