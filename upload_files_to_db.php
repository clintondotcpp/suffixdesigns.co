...
$user = "Kurinton";
$pass = "@@90210@@";
//$database = "salesoffer";    /*change */

//input variables
$product_price = $product_description = "";

$mysqli = new mysqli($host, $user, $pass, $database) or die(mysqli_error(mysqli));
//$local_dir = 'C:\Users\Nnamdi\Desktop\webdev\mywebsitecompressedfiles\GIFFOLDER';
//$local_server_dir = 'SALES';
...
for($i = 0; $i < count($files); $i++){
    ...
    $product_description = "✔Satisfaction guaranteed- unlimited revisions.
