...
try {
    $conn = new mysqli('localhost', 'roosevi0_Kurinton', '@@90210@@', 'roosevi0_illustrations');
                            ...
                            <form method="post" action="./orderupload.php?product=<?php echo $product['stripe_id']; ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <div class="row gy-3">
                                    <div class="col-12">
                                        ...
                                        <input type="email" class="form-control needs-validation" id="email" name="email" placeholder="" required="">
                                    ...
                                    <div class="col-12">
                                        <textarea name="instructions" id="" cols="30" rows="5" name="instructions" placeholder="Customize your design. This is optional. We will contact you regardless via email within 24hrs to ask for more details or pictures for optimal satisfaction."></textarea>
                                    </div>
                                </div>
            ...
            <footer class="py-5 px-3 bg-dark">
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-1 mb-3">
                        <form action="newsletter.php" method="post" class="needs-validation">
