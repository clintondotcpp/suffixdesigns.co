...
try {
    $conn = new mysqli('localhost', 'Kurinton', '@@90210@@', 'logos');
        ...
        <body>
                            ...
                            <form method="post" action="../orderupload.php?product=<?php echo $product['stripe_id']; ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <div class="row gy-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control needs-validation" type="file" id="headshot" name="headshot" required onchange="fileValidation()">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Upload a picture</label>
                                        <input class="form-control needs-validation" id="logo" type="file" name="logo" required>
                                        <div class="invalid-feedback">
                                            Logo is required
                                        </div>
                                    </div>
                                ...
                                <button class="w-100 btn btn-primary btn-lg mt-2" type="submit" name="submit" value="submit" id="upload_btl">Continue to checkout</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <!--<script>
                ...
                document.getElementById('upload_btl').onclick = function() {
                    var image = document.getElementById('headshot').value;
                    if (image != '') {
                        var checkimg = image.toLowerCase();
                        if (!checkimg.match(/(\.jpg|\.png|\.JPG|\.PNG|\.jpeg|\.JPEG)$/)) {
                            alert("Please Select jpg,png File");
                            document.getElementById('headshot').value = "";
                            document.getElementById('headshot').innerHTML = "Choose file";
                            exit;
                        }
