<?php
//connect to database
$conn = mysqli_connect('localhost', 'roosevi0_Kurinton', '@@90210@@', 'roosevi0_salesoffer');
...
<head>
  ...
  <title>Suffix Designs: Discount Offers</title>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="salesoffer.php?product=<?php echo $product['product_id']; ?>" id="link-color" class="btn btn-primary">Pay USD <?php echo htmlspecialchars($product['product_price']); ?></a>
            </div>
          </div>
        </div>
      <?php } ?>
